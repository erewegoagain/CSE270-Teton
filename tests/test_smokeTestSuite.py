...
class TestSmokeTestSuite():
  ...
  def test_adminPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("Haha")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("haha")
    self.driver.find_element(By.CSS_SELECTOR, ".mysubmit:nth-child(4)").click()
    WebDriverWait(self.driver, 0.01).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".errorMessage")))
